                    ...
                    >
                        ...
                        <div className="p-6 sm:p-10">
                            <div className="flex justify-between items-start mb-6">
                                ...
                                <div className={`p-2 rounded-full text-xs font-bold uppercase tracking-wider ${getDifficultyColor(recipe.difficulty)} shadow-lg`}>
                                    {recipe.difficulty}
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col sm:flex-row justify-between items-center bg-gray-700/50 p-4 rounded-xl mb-10 shadow-inner border border-gray-600">
                                <div className="flex space-x-6 sm:space-x-10 text-center mb-4 sm:mb-0">
                                    <div className="flex flex-col">
                                        <span className="text-2xl font-bold text-white">{recipe.cookTime} min</span>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                                ...
                                {/* Ingredients List (1/3 width on desktop) */}
